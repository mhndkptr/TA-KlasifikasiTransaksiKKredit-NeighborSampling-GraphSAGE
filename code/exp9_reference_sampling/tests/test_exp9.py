...
from exp9.artifacts import atomic_torch, load_or_prepare, write_summaries
from exp9.config import load_config, validate_config
from exp9.data import FeatureEncoder, load_transactions
from exp9.evaluation import build_contexts, predict
from exp9.graph import FeatureStore, build_graph
from exp9.metrics import calibrate_threshold, long_tail_mask
from exp9.minibatch import sample_blocks, training_batches
from exp9.model import GraphSAGE
from exp9.sampling import NeighborTableSampler, build_weights
from exp9.trainer import run_one
...
class DataTests(unittest.TestCase):
    ...
    def test_encoder_fits_train_only_and_serializes_oov(self):
        ...
        self.assertEqual(diagnostics["numeric_outside_train_range"]["_amount"], 1.0)
