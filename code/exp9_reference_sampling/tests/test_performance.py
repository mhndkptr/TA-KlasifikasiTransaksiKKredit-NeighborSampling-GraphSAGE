...
from exp9.artifacts import atomic_json, write_summaries
...
from exp9.runs import RunDirectory
from exp9.sampling import NeighborTableSampler
from exp9.sampling.weights import historical_topology
from tests.test_exp9 import ROOT, fixture_graph
...
class FactorizationTests(unittest.TestCase):
    ...
    def test_gpu_preset_preserves_scientific_settings(self):
        ...
        self.assertEqual(gpu["runtime"]["feature_device"], "cuda")
