...
def main(argv=None):
    parser = argparse.ArgumentParser(description="EXP11: modular GraphSAGE with frozen training context")
    ...
    parser.add_argument("--name", help="Separate run name, e.g. exp11_subset")
