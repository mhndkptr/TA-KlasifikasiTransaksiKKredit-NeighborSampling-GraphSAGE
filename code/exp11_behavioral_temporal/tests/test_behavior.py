...
from exp11.behavior import FEATURE_NAMES, fill_behavior_features
from exp11.config import load_config, validate_config
from exp11.data import load_transactions
from exp11.graph import build_graph
from exp11.protocol import positive_channel_weights, selection_bounds, stopping_decision
...
class BehavioralTests(unittest.TestCase):
    ...
    def test_selection_and_calibration_are_disjoint_and_stop_has_warmup(self):
        cfg = validate_config(load_config(ROOT/'config.yaml'))
