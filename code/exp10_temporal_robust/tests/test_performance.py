...
from exp10.artifacts import atomic_json, write_summaries
...
from exp10.metrics import binary_metrics
from exp10.runs import RunDirectory
from exp10.sampling import NeighborTableSampler
from exp10.sampling.weights import historical_topology
...
class FactorizationTests(unittest.TestCase):
    ...
    def test_gpu_preset_preserves_scientific_settings(self):
        ...
        expected_training = dict(base['training'], batch_size=4096)
