...
def main(argv=None):
    ...
    parser.add_argument("--selection-min-fraud", type=int,
                        help="Subset/smoke guard override; main config remains authoritative")
    parser.add_argument("--calibration-min-fraud", type=int,
                        help="Subset/smoke guard override; main config remains authoritative")
    parser.add_argument("--name", help="Separate run name, e.g. exp12_subset")
    ...
    for argument, section, key in (("device", "experiment", "device"), ("max_rows", "experiment", "max_rows"),
                                  ...
                                  ("calibration_min_fraud", "evaluation", "calibration_min_fraud")):
