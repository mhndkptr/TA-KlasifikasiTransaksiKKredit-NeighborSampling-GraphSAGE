...
SPEC = importlib.util.spec_from_file_location("exp7_test_module", MODULE_PATH)
MODULE = importlib.util.module_from_spec(SPEC)
sys.modules[SPEC.name] = MODULE
SPEC.loader.exec_module(MODULE)


class Exp7MemoryBoundedTest(unittest.TestCase):
    ...
    def test_memory_bounded_ppr_matches_exp5_exact_weights(self):
        edges = []
        ...
        bounded = MODULE.MemoryBoundedExactGPUSampler(
            edge_index, num_nodes, known, "importance", [2], cfg, device, 42,
        )
